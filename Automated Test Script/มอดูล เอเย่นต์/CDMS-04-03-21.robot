...
**Variables**
${agn_company_name}         ร่ำรวย จำกัด6
...
**Keywords**
add_agent_agn_firstname_length_0
...
Case CDMS-04-03-21
    ...
    sleep                                           1s
    add_agent_agn_firstname_length_0
    Element Text Should Be                          //*[@id="agent_section"]/div[2]/div[2]/div[2]/label            Please enter a first name
    sleep                                           1s
