...
**Variables**
${agn_company_name}         ร่ำรวย จำกัด12
...
${agn_firstname_lastname}   ขยัน 1234
${agn_tel_format}           081-234-5678

**Keywords**
add_agent_wrong_agn_lastname_format
...
Case CDMS-04-03-27
    ...
    sleep                                           1s
    add_agent_wrong_agn_lastname_format
    Element Text Should Be                          //*[@id="agent_section"]/div[2]/div[2]/div[4]/label            Enter letters only
    sleep                                           1s