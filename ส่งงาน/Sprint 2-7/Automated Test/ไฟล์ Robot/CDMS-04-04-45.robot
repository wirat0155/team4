...
${agn_tel}        0812345678
${agn_email}      nwamin123456789123456789123456@gmail.com
${agn_firstname_lastname}    นวมินทร์ อินทราทิพย์
${agn_tel_format}    081-234-5678

*** Keywords ***
update_agent_agn_email_length_40
...
Case CDMS-04-04-45
    ...
    sleep    1s
    update_agent_agn_email_length_40
    Element Text Should Be    xpath=//*[@id="Agent_list_table"]/tbody/tr[1]/td[6]    nwamin123456789123456789123456@gmail.com
    sleep    1s
