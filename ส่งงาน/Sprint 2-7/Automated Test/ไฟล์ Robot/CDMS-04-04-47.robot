...
*** Keywords ***
update_agent_duplicate _agn_company_name
...
Case CDMS-04-04-47
    ...
    sleep    1s
    update_agent_duplicate _agn_company_name
    Element Text Should Be    //*[@id="add_agent_form"]/div[2]/div/div[1]/div[1]/div/label    The agent has already used
    sleep    1s
