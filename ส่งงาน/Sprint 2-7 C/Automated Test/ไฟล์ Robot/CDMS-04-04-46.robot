...
${agn_tel}        0812345678
${agn_email}      nwamin1234567891234567891234567@gmail.com
${agn_firstname_lastname}    นวมินทร์ อินทราทิพย์
${agn_tel_format}    081-234-5678

*** Keywords ***
update_agent_agn_email_length_41
...
Case CDMS-04-04-46
    ...
    sleep    1s
    update_agent_agn_email_length_41
    Element Text Should Be    //*[@id="add_agent_form"]/div[2]/div/div[2]/div[5]/div/div/label    Please enter 40 Character digit
    sleep    1s
